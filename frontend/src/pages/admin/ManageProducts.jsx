...
export default function ManageProducts() {
  const [products, setProducts] = useState([
    { id: 1, name: 'Product 1', category: 'Electronics', price: 99.99, stock: 45 },
    { id: 2, name: 'Product 2', category: 'Fashion', price: 79.99, stock: 32 },
    { id: 3, name: 'Product 3', category: 'Home', price: 49.99, stock: 18 },
  ]);
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {products.map((product) => (
              <tr key={product.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                ...
                <td className="px-6 py-4 text-sm text-gray-900 dark:text-white font-semibold">${product.price}</td>
